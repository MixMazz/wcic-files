...
const FISH_LOCATION = ['Sea', 'River', 'Pond', 'Pier', 'River (clifftop)', 'River (mouth)', 'Sea (rainy days)'] as const;
const FISH_SHADOW = ['XS', 'S', 'M', 'L', 'XL', 'XXL', 'Fin', 'Narrow'] as const;
...
const SEALIFE_SPEED = ['none', 'extra slow', 'slow', 'medium', 'fast', 'extra fast'] as const;
